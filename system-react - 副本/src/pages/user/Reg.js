...
export default function AddStorelist() {
    ...
    async function onFinish (values){
        try {
            ...
            if (data.code === 1) {
               ...
               formIns.current.resetFields(['account', 'Password', 'userGroup'])
            } else {
    ...
    return (
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}>1
                <Form
                    {...layout}
                    name="basic"
